...
public class PlantSeedsDispenserBehavior implements IDispenseItemBehavior {
	...
	public ItemStack dispense(IBlockSource dispenser, ItemStack itemStack) {
		...
		BlockItem cropBlock = (BlockItem)itemStack.getItem();

		cropBlock.tryPlace(new DirectionalPlaceContext(world, forwardPos, Direction.DOWN, itemStack, Direction.UP));
